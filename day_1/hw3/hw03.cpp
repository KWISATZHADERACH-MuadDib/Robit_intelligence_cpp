...
//정보 입력
void yep::Point::getInput(int& num, int& min_coor, int& max_coor) {
...
void yep::Point::generatePoint(int size, int min_coor, int max_coor) {
...
void yep::Point::calcPointDist(int size, _Point* arr, double& MinDist, double& MaxDist, _Point& minPoint1, _Point& minPoint2, _Point& maxPoint1, _Point& maxPoint2) {
	int x1, y1;
	int x2, y2;
	int diff_x, diff_y;
	double dist;
...
void yep::Point::printResult(double MinDist, double MaxDist, _Point minPoint1, _Point minPoint2, _Point maxPoint1, _Point maxPoint2) {
	cout << "-------- Result --------" << endl;
...
int main()
{
	...
	yep::_Point minPoint1, minPoint2, maxPoint1, maxPoint2;

	yep::Point p;

	p.getInput(num, min_coor, max_coor);
	p.generatePoint(num, min_coor, max_coor);
	p.calcPointDist(num, p.arr, Mindist, Maxdist, minPoint1, minPoint2, maxPoint1, maxPoint2);
	p.printResult(Mindist, Maxdist, minPoint1, minPoint2, maxPoint1, maxPoint2);
